    ...
    <footer className="border-t border-border bg-background py-8 md:py-12">
      <div className="container mx-auto px-4 md:px-6 flex flex-col items-center">
        <div className="flex gap-6 mb-6">
          <a
            href="https://github.com/imzohair9"
            target="_blank"
        ...
        <p className="text-center text-sm text-muted-foreground">
          © {currentYear} Muhammad Zohair. All rights reserved.
        </p>
        <p className="mt-2 text-center text-xs text-muted-foreground flex items-center gap-1 justify-center">
